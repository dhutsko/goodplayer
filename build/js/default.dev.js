...
/**src/js/lib/3/dust-full-2.3.3.js**/
            ...
            parse: function(input, startRule) {
                ...
                function parse_path() {
                    ...
                    if (result0 !== null) {
                        result0 = (function(offset, line, column, k, d) {
                            ...
                            if (k && d) {
                                d.unshift(k);
                                return [false, d].concat([
                                    ['line', line],
                                    ['col', column]
                                ]);
                            }
                            return [true, d].concat([
                                ['line', line],
                                ['col', column]
                            ]);
                    ...
                    if (result0 === null) {
                        ...
                        if (result1 !== null) {
                            result1 = (function(offset, line, column, c) {
                                return c
                            })(pos1.offset, pos1.line, pos1.column, result1[4]);
                        }
                        if (result1 === null) {
                            pos = clone(pos1);
                        }
                ...
                function parse_raw() {
                    ...
                    if (result0 !== null) {
                        ...
                        if (result2 !== null) {
                            result2 = (function(offset, line, column, char) {
                                return char
                    ...
                    if (result0 !== null) {
                        result0 = (function(offset, line, column, rawText) {
                            return ["raw", rawText.join('')].concat([
                                ['line', line],
                                ['col', column]
                            ])
                        })(pos0.offset, pos0.line, pos0.column, result0[1]);
...
(function(root, factory) {
    ...
    var escape = (typeof JSON === 'undefined') ?
            function(str) {
                return '"' + escapeToJsSafeString(str) + '"';
        } :
            JSON.stringify;
...
(function(){dust.register("about_view",body_0);function body_0(chk,ctx){return chk.write("<div class=\"row\"><div class=\"span12\"><img class=\"about-icon\" src=\"/images/download.png\"><h3>Download the source code</h3><p>The source code for this application is available in <a href=\"https://github.com/dhutsko/goodplayer\"  target=\"_blank\">this repository</a> on GitHub.</p></div></div><br/><div class=\"row\"><div class=\"span12\"><img class=\"about-icon\" src=\"/images/discuss.png\"><h3>Comments and questions</h3><p>If you have any questions or comments please mail <a href=\"mailto:dhutsko@scnsoft.com\" target=\"_blank\">me</a>.</p></div></div>");}return body_0;})();(function(){dust.register("home_view",body_0);function body_0(chk,ctx){return chk.write("<div class=\"jumbotron\"><h1>Welcome to Good Player</h1><p>A simple application built with Backbone.js, Twitter Bootstrap, Dust.js, Node.js.</p><p>It includes the responsive CSS and HTML, so it also adapts to your viewport and device.</p><p><a class=\"btn btn-lg btn-primary\" href=\"https://github.com/dhutsko/goodplayer\" role=\"button\">View project on GitHub »</a></p></div>");}return body_0;})();(function(){dust.register("movie_details_view",body_0);function body_0(chk,ctx){return chk.write("<div class=\"container-movie-details\"><div class=\"row\"><div id=\"myCarousel\" class=\"carousel slide\" data-ride=\"carousel\"><div class=\"carousel-inner\" role=\"listbox\"><div class=\"item active\"><img class=\"first-slide\" src=\"/images/").reference(ctx.getPath(false, ["images","placeholder"]),ctx,"h").write("\" alt=\"").reference(ctx.get(["title"], false),ctx,"h").write("\"><div class=\"container\"><div class=\"carousel-caption\"><h1>").reference(ctx.get(["title"], false),ctx,"h").write(" (").reference(ctx.getPath(false, ["meta","releaseYear"]),ctx,"h").write(")</h1><p>").reference(ctx.get(["description"], false),ctx,"h").write("</p><p><a class=\"btn btn-lg btn-primary\" href=\"#movies\" role=\"button\">Back to movies</a></p></div></div></div></div></div></div><hr class=\"featurette-divider\"><div class=\"row\">").partial("video_player_view",ctx.rebase(ctx.getPath(true, [])),{}).write("</div></div>");}return body_0;})();(function(){dust.register("movies_view",body_0);function body_0(chk,ctx){return chk.write("<div class=\"row text-center\">").partial("video_player_view",ctx.rebase(ctx.getPath(true, ["0"])),{}).write("</div><div class=\"row text-center\">").section(ctx.getPath(true, []),ctx,{"block":body_1},{}).write("</div>");}function body_1(chk,ctx){return chk.write("<div class=\"col-lg-3\"><a class=\"btn-preview\" data-id=\"").reference(ctx.get(["id"], false),ctx,"h").write("\" href=\"#\"><img src=\"/images/").reference(ctx.getPath(false, ["images","cover"]),ctx,"h").write("\" alt=\"Generic placeholder image\" width=\"141\" height=\"199\"><h6>").reference(ctx.get(["title"], false),ctx,"h").write(", ").reference(ctx.getPath(false, ["meta","releaseYear"]),ctx,"h").write("</h6></a><p><a href=\"#movies/").reference(ctx.get(["id"], false),ctx,"h").write("\" class=\"btn btn-default btn-movie-details\" href=\"#\" role=\"button\">View details &raquo;</a></p></div><!-- /.col-lg-2 -->");}return body_0;})();(function(){dust.register("video_player_view",body_0);function body_0(chk,ctx){return chk.write("<div id=\"video-player\"><video controls poster=\"/images/").reference(ctx.getPath(false, ["images","placeholder"]),ctx,"h").write("\" >").section(ctx.getPath(true, ["streams"]),ctx,{"block":body_1},{}).write("Your browser does not support the video tag.</video><div class=\"text-left\"><h3><span>").reference(ctx.getPath(true, ["title"]),ctx,"h").write("</span> (<span>").reference(ctx.getPath(true, ["meta","releaseYear"]),ctx,"h").write("</span>)</h3><p>").exists(ctx.getPath(true, ["meta","directors"]),ctx,{"block":body_2},{}).exists(ctx.getPath(true, ["meta","actors"]),ctx,{"block":body_4},{}).write("</p></div>\t</div>");}function body_1(chk,ctx){return chk.write("<source src=\"").reference(ctx.get(["url"], false),ctx,"h").write("\" type=\"video/").reference(ctx.get(["type"], false),ctx,"h").write("\">");}function body_2(chk,ctx){return chk.write("Directors: ").section(ctx.getPath(true, ["meta","directors"]),ctx,{"block":body_3},{}).write(" <br>");}function body_3(chk,ctx){return chk.write(" ").reference(ctx.get(["name"], false),ctx,"h").write(",");}function body_4(chk,ctx){return chk.write("Actors: ").section(ctx.getPath(true, ["meta","actors"]),ctx,{"block":body_5},{});}function body_5(chk,ctx){return chk.write(" ").reference(ctx.get(["name"], false),ctx,"h").write(",");}return body_0;})();;jQuery(function(){ window.version = {"localBuild":36,"timestamp":1428651667990}; });


/**src/js/core/helpers/template.js**/
(function(root, factory) {
    root.App = root.App || {};
...
/**src/js/core/models/movieModel.js**/
(function(root, factory) {
    root.App = root.App || {};
...
/**src/js/core/collections/movieCollection.js**/
(function(root, factory) {
    root.App = root.App || {};
...
/**src/js/core/views/aboutPageView.js**/
(function(root, factory) {
    root.App = root.App || {};
...
/**src/js/core/views/headerNavView.js**/
(function(root, factory) {
    root.App = root.App || {};
    root.App.Views = root.App.Views || {};
...
/**src/js/core/views/homePageView.js**/
(function(root, factory) {
    root.App = root.App || {};
    root.App.Views = root.App.Views || {};
    root.App.Views.HomeView = factory(root.$, root.Backbone, root.App);
    ...
    return Backbone.View.extend({
        template: App.Template('home_view'),
...
/**src/js/core/views/movieDetailsView.js**/
(function(root, factory) {
    root.App = root.App || {};
    root.App.Views = root.App.Views || {};
...
/**src/js/core/views/moviesPageView.js**/
(function(root, factory) {
    root.App = root.App || {};
    root.App.Views = root.App.Views || {};
...
/**src/js/core/views/videoPlayerView.js**/
(function(root, factory) {
    root.App = root.App || {};
    root.App.Views = root.App.Views || {};
